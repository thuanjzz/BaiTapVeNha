...
client = MongoClient('mongodb://localhost:27017/')  # Kết nối đến server MongoDB
db = client['tiktok']  # Chọn cơ sở dữ liệu tiktok

# Bước 2: Tạo bộ sưu tập cho người dùng và video
users_collection = db['users']  # Tạo bộ sưu tập users
videos_collection = db['videos']  # Tạo bộ sưu tập videos
